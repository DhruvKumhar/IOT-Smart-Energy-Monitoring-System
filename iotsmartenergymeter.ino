#define BLYNK_TEMPLATE_ID "TMPL31i1Ihm-1"
...
LiquidCrystal lcd(13, 12, 14, 27, 26, 25); //IF WE WANT TO 
EnergyMonitor emon;

#define vCalibration 60
#define currCalibration 4.6875

BlynkTimer timer;

char auth[] = "pJDsC33b7e14FW6ujmQ716Tyc_DMEUX-";
char ssid[] = "iQOO Z6";
char pass[] = "dhruvuniverse";
...
void myTimerEvent() {
  ...
  // IF NOTHING IS CONNECTED EVERYTHING IS ZERO
  if (emon.Vrms < 200) {
    emon.Vrms = 0;
    emon.Irms = 0;
    emon.realPower = 0;
